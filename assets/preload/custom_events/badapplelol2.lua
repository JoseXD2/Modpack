...
function onEvent(name, value1, value2)
	if name == 'badapplelol' and value1 == 'a' and hasSpawned == false then
		...
		doTweenColor('badapplexd3', 'pibby', '000000', value2, 'linear')
		doTweenColor('badapplexd4', 'brian', '000000', value2, 'linear')
		doTweenColor('badapplexd9', 'stewie', '000000', value2, 'linear')
	...
	if name == 'badapplelol' and value1 == 'b' then
		...
		doTweenColor('badapplexd8', 'pibby', 'FFFFFF', value2, 'linear')
		doTweenColor('badapplexd4', 'brian', 'FFFFFF', value2, 'linear')
		doTweenColor('badapplexd9', 'stewie', 'FFFFFF', value2, 'linear')
