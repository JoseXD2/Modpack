...
idleoffsets = {'0', '-420'} -- I recommend you have your idle offset at 0
leftoffsets = {'0', '-420'}
downoffsets = {'0', '-420'}
upoffsets = {'0', '-420'}
rightoffsets = {'0', '-420'}
...
name_of_character_xml = 'stewie'
name_of_character = 'stewie'
name_of_notetype = 'stewie'
name_of_notetype2 = 'stewie' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
