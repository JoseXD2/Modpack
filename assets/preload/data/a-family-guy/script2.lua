...
idleoffsets = {'300', '-200'} -- I recommend you have your idle offset at 0
leftoffsets = {'300', '-200'}
downoffsets = {'300', '-200'}
upoffsets = {'300', '-200'}
rightoffsets = {'300', '-200'}

-- change all of these to the name of the animation in your character's xml file
idle_xml_name = 'brian idle'
left_xml_name = 'brian left'
down_xml_name = 'brian down'
up_xml_name = 'brian up'
right_xml_name = 'brian right'
...
name_of_character_xml = 'brian'
name_of_character = 'brian'
name_of_notetype = 'brian'
name_of_notetype2 = 'brian' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
